...
llm = ChatOpenAI(
    ...
    extra_body={"keep_alive": 0, "options": {"num_ctx": 36000, "top_k": 20, "min_p": 0}},
    # streaming=True,
...
system_prompt = """You are an assistant AI of a company called CoreFlow.
...
asyncio.run(agent_executor.ainvoke({"input":"CoreFlow의 휴가 규정에 대해서 알려줘."}))
